...
describe('Transaction Controller - Add Transaction', function() {
  let res;
  ...
  it('should return an error if saving to the database fails', function(done) {
    ...
    Transaction.prototype.save.throws();
    ...
    addTransaction(req, res, () => {}).then(() => {
      ...
      expect(res.apiMessage).to.be.equal('Unable to create transaction');
  ...
  it('should return success if transaction created', function(done) {
    ...
    addTransaction(req, res, () => {}).then(() => {
      ...
      expect(res).to.have.property('apiMessage');
      expect(res.apiMessage).to.equal('Transaction created');
      expect(res).to.have.property('errorCode');
